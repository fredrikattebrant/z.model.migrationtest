...
public class W3schoolsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case W3schoolsPackage.DESCR_TYPE: {
				DescrType descrType = (DescrType)theEObject;
				T result = caseDescrType(descrType);
			...
			case W3schoolsPackage.NOTE_TYPE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Descr Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Descr Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDescrType(DescrType object) {
		return null;
	}
