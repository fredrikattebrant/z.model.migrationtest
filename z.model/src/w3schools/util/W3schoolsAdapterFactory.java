...
public class W3schoolsAdapterFactory extends AdapterFactoryImpl {
	...
	protected W3schoolsSwitch<Adapter> modelSwitch =
		new W3schoolsSwitch<Adapter>() {
			@Override
			public Adapter caseDescrType(DescrType object) {
				return createDescrTypeAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link w3schools.DescrType <em>Descr Type</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createDescrTypeAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link w3schools.DocumentRoot <em>Document Root</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link w3schools.NoteType <em>Note Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
