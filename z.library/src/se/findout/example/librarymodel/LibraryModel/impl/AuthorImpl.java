 ...
 * <ul>
 *   <li>{@link se.findout.example.librarymodel.LibraryModel.impl.AuthorImpl#getBooks <em>Books</em>}</li>
 *   <li>{@link se.findout.example.librarymodel.LibraryModel.impl.AuthorImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AuthorImpl extends EObjectImpl implements Author {
	...
	public EList<Book> getBooks() {
		if (books == null) {
			books = new EObjectWithInverseResolvingEList<Book>(Book.class, this, LibraryModelPackage.AUTHOR__BOOKS, LibraryModelPackage.BOOK__AUTHOR);
		}
		return books;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LibraryModelPackage.AUTHOR__BOOKS:
