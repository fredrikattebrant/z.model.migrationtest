 ...
 * @generated
 */
public class LibraryModelPackageImpl extends EPackageImpl implements LibraryModelPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see se.findout.example.librarymodel.LibraryModel.LibraryModelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private LibraryModelPackageImpl() {
		super(eNS_URI, LibraryModelFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link LibraryModelPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static LibraryModelPackage init() {
		if (isInited) return (LibraryModelPackage)EPackage.Registry.INSTANCE.getEPackage(LibraryModelPackage.eNS_URI);

		// Obtain or create and register package
		LibraryModelPackageImpl theLibraryModelPackage = (LibraryModelPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof LibraryModelPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new LibraryModelPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theLibraryModelPackage.createPackageContents();

		// Initialize created meta-data
		theLibraryModelPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theLibraryModelPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(LibraryModelPackage.eNS_URI, theLibraryModelPackage);
		return theLibraryModelPackage;
	}
	 ...
	 * @generated
	 */
	public LibraryModelFactory getLibraryModelFactory() {
		return (LibraryModelFactory)getEFactoryInstance();
	}
